		...
		<div class="nav-links">
			...
			if ( $is_first_page ) : ?>
				<span class="page-numbers disabled" 
					  aria-disabled="true" 
					  aria-label="<?php esc_attr_e( 'First page (current)', 'main' ); ?>"
			...
			if ( $is_first_page ) : ?>
				<span class="page-numbers disabled" 
					  aria-disabled="true" 
					  aria-label="<?php esc_attr_e( 'Previous page (unavailable)', 'main' ); ?>"
			...
			if ( $is_last_page ) : ?>
				<span class="page-numbers disabled" 
					  aria-disabled="true" 
					  aria-label="<?php esc_attr_e( 'Next page (unavailable)', 'main' ); ?>"
			...
			if ( $is_last_page ) : ?>
				<span class="page-numbers disabled" 
					  aria-disabled="true" 
					  aria-label="<?php esc_attr_e( 'Last page (current)', 'main' ); ?>"
