  ...
  blocks.registerBlockType("main/article-carousel", {
    edit: function (props) {
      ...
      var blockProps = useBlockProps({
        className: "theme-main article-carousel article-carousel-editor",
      });
      ...
      return el(
        ...
        el(
          ...
          el(
            ...
            el(RichText, {
              ...
              className: "article-carousel-heading-input",
              allowedFormats: [],
            })
          ),
          el(
        ...
        el(
          "section",
          { 
            className: "security-guides-section bg-gray-25 py-16 md:py-24 overflow-hidden" 
          },
          el(
            "div",
              ...
              el(
                ...
                el(
                  "button",
                  {
                    ...
                    className: "btn btn--outline rounded-full max-sm:py-2 max-sm:px-3",
                  ...
                  el("svg", {
                    ...
                    height: "16",
                    viewBox: "0 0 100 100"
                  }, el("style", null, ".s0 { fill: none; stroke: #252b37; stroke-linecap: round; stroke-linejoin: round; stroke-width: 9.4; }"),
                    el("path", {
                ...
                el(
                  ...
                  el("svg", {
                    ...
                    height: "16",
                    viewBox: "0 0 16 16"
                  }, el("style", null, ".se0 { fill: none; stroke: #252b37; stroke-linecap: round; stroke-linejoin: round; stroke-width: 1.5; }"),
                    el("path", {
