...
<article 
    ...
    class="bg-white border border-gray-200 rounded-2xl md:rounded-3xl relative <?php echo $is_highlighted ? 'mt-[1.3125rem] md:mt-0' : 'mt-[1.3125rem] md:mt-0'; ?>"
    itemscope
    ...
    <div class="p-5 md:p-6 lg:p-7 xl:p-8 flex flex-col gap-8 md:gap-10 lg:gap-12 [&_p]:my-0 [&_p:empty]:hidden">
        <!-- Product Header -->
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-6">
            <div class="flex flex-col gap-6 md:gap-4">
                    ...
                    <?php if ( $product['logo'] ) : ?>
                        <div class="product-logo-wrap w-12 [&_img]:w-full [&_img]:h-auto md:w-20 [&_img]:m-0">
                            ...
                            if ( $logo_attachment_id ) {
                                // Use WordPress attachment image function for better handling
                ...
                <!-- Product Badges -->
                <div class="flex flex-row flex-wrap items-start content-start p-0 gap-2">
                    <?php echo main_get_product_badges( $product ); ?>
                </div>
            </div>
            
            <!-- CTA Button -->
            <a href="<?php echo esc_url( $product['website_url'] ?: $product['permalink'] ); ?>" 
