  ...
  blocks.registerBlockType("main/explore-categories", {
    edit: function (props) {
      ...
      var blockProps = useBlockProps({
        className: "theme-main explore-category-section explore-categories-editor",
      });
      ...
      return el(
        ...
        el(
          "div",
          { className: "theme-main explore-category-section py-6 md:py-8 lg:py-10" },
          el(
            "div",
            ...
            el(
              ...
              {
                className:
                  "home-categories-container rounded-3xl md:rounded-4xl p-5 md:p-12 lg:p-16 xl:p-24 flex flex-col gap-6 md:gap-11 lg:gap-12 xl:gap-14",
              },
              heading &&
                el(
                  "h2",
