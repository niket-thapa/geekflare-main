...
<div class="overflow-auto rounded-2xl md:rounded-3xl border border-gray-200 my-14 lg:mt-16 lg:mb-20">
    <table class="product-compare-table border-none w-full table-fixed">
        <thead>
            <tr>
                ...
                <?php foreach ( $columns as $column ) : 
                    ...
                    if ( $column_width && 'auto' !== $column_width ) {
                        $width_style = ' style="width: ' . esc_attr( $column_width ) . '; min-width: ' . esc_attr( $column_width ) . '; max-width: ' . esc_attr( $column_width ) . ';"';
                    }
                ?>
                        ...
                        <div class="flex gap-2 items-center md:gap-3 px-4 py-[1.0625rem] md:px-6 md:py-5.5">
                            <?php if ( ! empty( $product['logo'] ) ) : ?>
                                <div class="product-logo-wrap w-6 [&_img]:w-full [&_img]:h-auto md:w-8 md:gap-3">
                                    <img src="<?php echo esc_url( $product['logo'] ); ?>" alt="<?php echo esc_attr( $product['name'] ); ?>" width="32" height="32" />
                                </div>
                            <?php endif; ?>
