        ...
        el(
          ...
          el(
            ...
            el(
              ...
              __("Product Score Breakdown", "main")
            ),
            ...
            (function () {
              ...
              var cards = scoreBreakdown.map(function (criterion, index) {
                ...
                return el(
                  ...
                  el(
                    ...
                    {
                      className:
                        "product-score-bar flex flex-row items-center p-0 gap-0.5 flex-none self-stretch",
                    },
              ...
              return el(
                ...
                el(
                  ...
                  {
                    className:
                      "product-score-cards grid grid-cols-2 lg:grid-cols-4 items-start p-0 gap-3 md:gap-4 flex-none self-stretch",
                  },
                  cards
                ),
                footer
