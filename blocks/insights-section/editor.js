...
(function (blocks, blockEditor, element, components, i18n) {
  ...
  blocks.registerBlockType("main/insights-section", {
    edit: function (props) {
      ...
      var heading = attributes.heading || "Fresh insights to help you make smarter software decisions";
      ...
      var headingAlignClass = "text-" + (headingAlign === "center" ? "center" : headingAlign === "right" ? "right" : "left");
        ...
        el(
          ...
          el(
            ...
            el(SelectControl, {
              ...
              value: "",
              options: [{ label: __("Select Category", "main"), value: "" }].concat(getCategoryOptions()),
            ...
            categories.length > 0 &&
              categories.map(function (categoryId, index) {
                ...
                var categoryName = category ? (category.name || "Unknown") : "Loading...";
                return el(
                  "div",
                  {
                    key: index,
          ...
          el(
            ...
            showButton && buttonLinkType === "category" &&
              el(SelectControl, {
            ...
            showButton && buttonLinkType === "custom" &&
              el(TextControl, {
        ...
        el(
          ...
          el(
            ...
            el(
              ...
              el(RichText, {
                tagName: "h2",
                className: "text-3xl md:text-5xl font-bold font-gilroy text-gray-900 leading-none md:leading-none max-w-[66rem]",
                value: heading,
                onChange: function (value) {
                  setAttributes({ heading: value });
                },
            ...
            el(
              "div",
              { className: "flex flex-col gap-20 lg:grid lg:grid-cols-2 lg:gap-16 xl:gap-24" },
                    ...
                    return el(
                      ...
                      el(
                        ...
                        el(
                          "div",
                          {
                            className: "absolute top-3 start-3 m-0.25 inline-flex items-center gap-1 px-2.5 py-2 rounded-full bg-white text-xs leading-[1.25] font-semibold text-primary shadow-sm"
                          },
                          el(
                            "span",
                            { className: "inline-flex h-4 w-4 items-center justify-center", "aria-hidden": "true" },
                            el("svg", {
                      ...
                      el(
                        ...
                        el(
                          ...
                          categories.length > 0 && categories[0] ? (getCategoryData(categories[0]) ? getCategoryData(categories[0]).name : "Category") : "Business Software"
                        ),
                        el(
                          "h3",
                          { className: "text-xl md:text-2xl font-semibold text-gray-900 md:-tracking-2p" },
                          "Sample Sticky Post Title " + i
                        ),
                        el(
                          "div",
                          { className: "text-sm font-medium text-gray-500 leading-5 tracking-1p" },
                          "This is a sample description for a sticky post that will be replaced with real content on the frontend."
                        ),
                        el(
                          "a",
                          { href: "#", className: "text-sm font-semibold text-primary hover:text-primary-hover py-2 md:py-3" },
                          "Read Guide"
                        )
                      )
                    );
              ...
              el(
                ...
                [1, 2, 3].map(function(i) {
                  ...
                  return el(
                    ...
                    { 
                      key: i,
                      className: "flex flex-col gap-4" + (isLast ? "" : " border-b border-gray-200 pb-8")
                    },
                    el(
                      "div",
                      { className: "text-xs font-semibold tracking-widest uppercase text-primary" },
                      categories.length > 0 && categories[0] ? (getCategoryData(categories[0]) ? getCategoryData(categories[0]).name : "Category") : "HR & People"
                    ),
                    el(
                      "div",
                      ...
                      el(
                        "h3",
                        { className: "text-lg md:text-xl md:-tracking-2p font-semibold text-gray-900 line-clamp-1" },
                        "Sample Regular Post Title " + i
                      ),
                      el(
                        "div",
                        { className: "text-sm font-medium text-gray-500 leading-5 tracking-2p md:tracking-1p line-clamp-1" },
                        "This is a sample description for a regular post that will be replaced with real content on the frontend."
                      )
                    ),
                    el(
                      "a",
                      { href: "#", className: "text-sm font-semibold text-primary hover:text-primary-hover md:py-2 md:mt-1" },
                      "Read Guide"
                    )
                  );
                })
