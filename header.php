...
<div id="page" class="site">
	...
	<header id="site-header" class="site-header py-2.5 md:py-3 lg:py-0 border-b border-gray-200">
		<div class="container-1216 py-1 lg:py-0 flex flex-wrap items-center gap-5">
			<div class="site-logo">
				<?php
				if ( has_custom_logo() ) {
			...
			<div class="flex items-center gap-3 max-lg:ms-auto">
				<?php
				// Header Search
				...
				if ( $show_search ) :
					...
					<div class="header-search hidden md:block">
						<button class="header-search__toggle button p-3 flex" type="button" aria-label="<?php esc_attr_e( 'Open search', 'main' ); ?>" aria-expanded="false">
						...
						<form class="header-search__form" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" aria-hidden="true">
							...
							<input 
								...
								autocomplete="off" 
							/>
							<button type="submit" class="btn btn--primary header-search__submit" aria-label="<?php esc_attr_e( 'Submit search', 'main' ); ?>">
				...
				if ( $show_lang_menu ) :
					...
					<div class="header-lang-menu">
						<button type="button" class="header-lang-menu__toggle btn btn--secondary rounded-full px-3 hidden md:flex" aria-haspopup="true" aria-expanded="false">
