 ...
 */
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'flex flex-col gap-5.5 md:gap-6' ); ?>>
	<?php if ( has_post_thumbnail() ) : ?>
		<a href="<?php the_permalink(); ?>" class="relative rounded-2xl overflow-hidden block">
	...
	<div class="flex flex-col gap-4">
		...
		<div class="flex flex-col gap-2">
			<?php the_title( '<h3 class="text-lg font-semibold"><a href="' . esc_url( get_permalink() ) . '" class="text-gray-900 hover:text-eva-prime-600">', '</a></h3>' ); ?>
